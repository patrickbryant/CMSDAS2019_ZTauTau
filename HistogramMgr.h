...
public:
  ...
  void Fill( const double eventweight, const int tau , TLorentzVector tauP4 , const int lep=-1 );
  void Write();
private:
...
void ObjectHisto::Fill( const double eventweight, const int tau, TLorentzVector tauP4, const int iLep )
{
...
void EventHisto::Fill( const int tau, TLorentzVector tauP4, const int iLep, const double evtweight )
{
  static const double muMass = 0.10565837;
  static const double elMass = 0.000511  ;
